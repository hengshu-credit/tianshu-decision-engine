...
.canvas-collapse { position: relative; width: 32px; flex: none; border: 1px solid #d8e1ec; border-radius: 7px; background: #fff; color: #607089; cursor: pointer; }
.canvas-collapse:hover { border-color: #9fc1f8; background: #edf5ff; color: #2878ff; }
