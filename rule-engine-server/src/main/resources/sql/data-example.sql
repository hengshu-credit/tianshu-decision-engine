...
(3, 1, 'PROJECT', 'calculateVAT', '费用试算(Java)', '演示 Java 反射函数：按金额与费率计算费用', '[{"name":"amount","type":"NUMBER","label":"金额"},{"name":"rate","type":"NUMBER","label":"费率"}]', 'NUMBER', 'JAVA', NULL, 'com.bjjw.rule.example.functions.TaxFunctions', 'calculateVAT', NULL, 1, NOW(), NOW()),
