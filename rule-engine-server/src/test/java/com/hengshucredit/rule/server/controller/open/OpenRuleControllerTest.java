...
public class OpenRuleControllerTest {
    ...
    public void acceptsDirectBusinessJsonAndUsesSameEnvelopeForSuccessAndFailure() {
        ...
        Assert.assertEquals("RULE_EXECUTION_FAILED", ((Map<?, ?>) failureBody.get("payload")).get("errorCode"));
    ...
    public void mappingErrorsUseThePublishedEnvelope() {
        ...
        Assert.assertEquals("REQUEST_INVALID", body.get("retCode"));
        Assert.assertEquals("REQUEST_INVALID", ((Map<?, ?>) body.get("payload")).get("errorCode"));
    }
